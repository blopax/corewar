...
/*   Updated: 2018/05/31 19:08:56 by nvergnac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_store_indirect(t_info *info, t_proc *proc)
{
	...
	val2 = ft_get_param(info, proc, 2, info->board[proc->pc - 1]);
	ft_uint_to_ptr(info, (proc->pc - 2 + ft_idx_mod_bis(val1 + val2)) % MEM_SIZE,
